...
//Se lanza y se ejecuta con http://localhost:8090 o la URL específica al proveedor cloud
...
public class ProtobootappApplication {
    ...
    //Se ejecuta con http://localhost:8090/
    @GetMapping("/")
    public String index() {
    ...
    //Se ejecuta con http://localhost:8090/hola o http://localhost:8090/hola?nombre=John
    @GetMapping("/hola")
    public String hola(@RequestParam(value = "nombre", defaultValue = "Mundo") String nombre) {
        return String.format("Hola %s!", nombre);
    }
    
    //Se ejecuta con http://localhost:8090/cuadrado o http://localhost:8090/cuadrado?numero=5
    @GetMapping("/cuadrado")
    ...
    //Se ejecuta con http://localhost:8090/cubo o http://localhost:8090/cubo?numero=5
    @GetMapping("/cubo")
